...
def _fit_section() -> str:
    ...
    return "\n".join(
        [
            ...
            "(ln b)*x + c*ln x, then a/b/c recovered by exp), the",
            ...
            *forms,
            ...
            "x != 0, the exp-reciprocal x != 0 and y > 0, the Hoerl x > 0 and y > 0); the gaussian",
            ...
            "exp-reciprocal, Hoerl, logarithmic, square-root, sinusoid and gaussian forms (the",
