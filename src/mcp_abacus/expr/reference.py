    ...
    return "\n".join(
        [
            ...
            *forms,
            ...
            "logarithmic, square-root, sinusoid and gaussian forms (the saturation, hyperbolic",
            "and Laurent, being pure reciprocals/polynomials, stay exact in rational); and a",
            "polynomial needs",
