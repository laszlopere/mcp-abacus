...
def _solver_section() -> str:
    ...
    return "\n".join(
        [
            ...
            "              nelder-mead (any objective) or bfgs (extrema only).",
            ...
            "                         each bracket. The derivative-free engine for the variables",
            "                         form, and the multivariate one that takes any objective.",
            ...
            "                         than nelder-mead on a smooth bowl; the other variables-form",
            "                         engine. Refuses find-root (|expr| has a kink at the root).",
            "",
